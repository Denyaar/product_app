...
Future<List<Product>> fetchProducts() async {
  final response = await http.get('http://127.0.0.1:8984/products');
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Product Fetching',products: products),
    );
  }
}
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Product Fetching By Denyaar")),
        body: Center(
